...
class GraphNavServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadSnapshots = channel.stream_unary(
                '/bosdyn.api.graph_nav.GraphNavService/UploadSnapshots',
                request_serializer=bosdyn_dot_api_dot_graph__nav_dot_graph__nav__pb2.UploadSnapshotsRequest.SerializeToString,
                response_deserializer=bosdyn_dot_api_dot_graph__nav_dot_graph__nav__pb2.UploadSnapshotsResponse.FromString,
                )
...
def add_GraphNavServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadSnapshots': grpc.stream_unary_rpc_method_handler(
                    servicer.UploadSnapshots,
                    request_deserializer=bosdyn_dot_api_dot_graph__nav_dot_graph__nav__pb2.UploadSnapshotsRequest.FromString,
                    response_serializer=bosdyn_dot_api_dot_graph__nav_dot_graph__nav__pb2.UploadSnapshotsResponse.SerializeToString,
            ),
...
class GraphNavService(object):
    ...
    @staticmethod
    def UploadSnapshots(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/bosdyn.api.graph_nav.GraphNavService/UploadSnapshots',
            bosdyn_dot_api_dot_graph__nav_dot_graph__nav__pb2.UploadSnapshotsRequest.SerializeToString,
            bosdyn_dot_api_dot_graph__nav_dot_graph__nav__pb2.UploadSnapshotsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
