...
class PowerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetFanInformation = channel.unary_unary(
                '/bosdyn.api.PowerService/GetFanInformation',
                request_serializer=bosdyn_dot_api_dot_power__pb2.GetFanInformationRequest.SerializeToString,
                response_deserializer=bosdyn_dot_api_dot_power__pb2.GetFanInformationResponse.FromString,
                )
...
def add_PowerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetFanInformation': grpc.unary_unary_rpc_method_handler(
                    servicer.GetFanInformation,
                    request_deserializer=bosdyn_dot_api_dot_power__pb2.GetFanInformationRequest.FromString,
                    response_serializer=bosdyn_dot_api_dot_power__pb2.GetFanInformationResponse.SerializeToString,
            ),
...
class PowerService(object):
    ...
    def GetFanInformation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bosdyn.api.PowerService/GetFanInformation',
            bosdyn_dot_api_dot_power__pb2.GetFanInformationRequest.SerializeToString,
            bosdyn_dot_api_dot_power__pb2.GetFanInformationResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
